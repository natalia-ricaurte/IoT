    ...
    with st.expander('⬇️ Descargar lista de dispositivos añadidos'):
        ...
        if export_format == 'excel':
            st.download_button(
                ...
                data=buffer,
                file_name=f'dispositivos_{len(devices_export)}_{datetime.now().strftime("%Y%m%d")}.xlsx',
                mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
            )
            ...
            st.download_button(
                ...
                data=buffer,
                file_name=f'dispositivos_{len(devices_export)}_{datetime.now().strftime("%Y%m%d")}.csv',
                mime='text/csv'
            )
            ...
            st.download_button(
                ...
                data=buffer,
                file_name=f'dispositivos_{len(devices_export)}_{datetime.now().strftime("%Y%m%d")}.json',
                mime='application/json'
            )
